...
// ─── Page helpers ─────────────────────────────────────────────
export function getPage(room, pageId) {
...
export function mergeElements(page, incoming) {
    const accepted = [];
...
// ─── Auth helpers ─────────────────────────────────────────────
export function isTeacherByUserId(room, userId) {
...
export function isTeacherAuth(roomId, userId) {
    const room = rooms.get(roomId);
